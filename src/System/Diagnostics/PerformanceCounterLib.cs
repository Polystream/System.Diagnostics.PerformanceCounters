...
namespace System.Diagnostics
{
    ...
    internal class CategorySample
    {
        ...
        internal Dictionary<int, CounterDefinitionSample> CounterTable;
        readonly CategoryEntry _entry;
        internal Dictionary<string, int> InstanceNameTable;
        ...
        unsafe internal CategorySample(byte[] data, CategoryEntry entry, PerformanceCounterLib library)
        {
            ...
            fixed(byte* dataPtr = data)
            {
                ...
                if (numPerfObjects == 0)
                {
                    CounterTable = new Dictionary<int, CounterDefinitionSample>();
                ...
                CounterTable = new Dictionary<int, CounterDefinitionSample>(counterNumber);
        ...
        unsafe internal string[] GetInstanceNamesFromIndex(int categoryIndex)
        {
        ...
        internal Dictionary<string, Dictionary<string, InstanceData>> ReadCategory()
        {
...
#pragma warning restore 618
    ...
    internal class CounterDefinitionSample
    {
        ...
        internal CounterSample GetInstanceValue(string instanceName)
        {
            ...
            {
                var baseCategorySample = BaseCounterDefinitionSample._categorySample;
                var baseIndex = baseCategorySample.InstanceNameTable[instanceName];
                baseValue = BaseCounterDefinitionSample._instanceValues[baseIndex];
            }
        ...
        internal Dictionary<string, InstanceData> ReadInstanceData(string counterName)
        {
#pragma warning disable 618
...
#pragma warning restore 618
        ...
        internal CounterSample GetSingleValue()
        {
            ...
            long baseValue = 0;
            if (BaseCounterDefinitionSample != null)
                baseValue = BaseCounterDefinitionSample._instanceValues[0];
